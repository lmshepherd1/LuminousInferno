  ...
  'n3utils', '$window', '$timeout', function(n3utils, $window, $timeout) {
    ...
    link = function(scope, element, attrs, ctrl) {
      ...
      scope.update = function() {
        ...
        // console.log(axes)
        // console.log('the dataPerSeries x values need to be reformatted')
  ...
  '$window', '$log', '$rootScope', function($window, $log, $rootScope) {
    return {
      ...
      bootstrap: function(element, id, dimensions) {
        ...
        if(height>dimensions.top+dimensions.bottom)
        {
      ...
      createAxis: function(scale, key, options) {
        ...
        o = options[key];
        if(key === 'y' && options[key].type === 'linear')
        {
      ...
      xExtent: function(data, key) {
        ...
        // console.log('return the 300, 0 range here. needs to be reformatted somewhere else')
        // return [300, 0]
        return [new Date(Date.now()-300000), new Date(Date.now())]
        // return [from, to];
      },
